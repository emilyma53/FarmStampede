...
public class PlayerController : MonoBehaviour
{
  ...
  private void Awake() {
      ...
      //         Debug.LogError(attack.AttackName + "has wind up longer than the amount of time the player is frozen for");
      //     }
      // }
  }
  ...
  //     {
  //         ScoreManager.singleton.activateMultiplier(other.GetComponent<DoublePoints>());
  //     }
